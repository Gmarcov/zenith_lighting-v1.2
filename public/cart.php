        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                <div class="d-flex justify-content-between align-items-center pt-3 pb-4 pb-sm-5 mt-1">
                    <h2 class="h6 text-light mb-0">Produits</h2><a class="btn btn-outline-primary btn-sm ps-2"
                ...
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="../src/img/shop/catalog/3.png" width="160" alt="Product"></a>
                        <div class="pt-2">
                ...
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="../src/img/shop/catalog/4.png" width="160" alt="Product"></a>
                        <div class="pt-2">
                ...
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="../src/img/shop/catalog/2.png" width="160" alt="Product"></a>
                        <div class="pt-2">
                            ...
                            <div class="fs-sm"><span class="text-muted me-2">Color:</span>Pink / Beige / Dark blue
                            </div>
                ...
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="../src/img/shop/catalog/5.png" width="160" alt="Product"></a>
                        <div class="pt-2">
                ...
                <button class="btn btn-outline-accent d-block w-100 mt-4" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-arrow-repeat fs-base me-2" viewBox="0 0 16 16">
                        <path
                    ...
                    <div class="py-2 px-xl-2">
                        ...
                        <div class="mb-3 mb-4">
                            <label class="form-label mb-3" for="order-comments"><span
                                    class="badge bg-info fs-xs me-2">Note</span><span class="fw-medium">Commentaire
                        ...
                        <div class="accordion" id="order-options">
                            <div class="accordion-item">
                                <h3 class="accordion-header"><a class="accordion-button" href="#promo-code"
                                        ...
                                        aria-controls="promo-code">Code promo</a></h3>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header"><a class="accordion-button collapsed"
                                        ...
                                        aria-expanded="true" aria-controls="shipping-estimates">Prix de
                                        livraison</a>
                                </h3>
                                <div class="accordion-collapse collapse" id="shipping-estimates"
                                    ...
                                    <div class="accordion-body">
                                        <form class="needs-validation" novalidate>
                                            ...
                                            <div class="mb-3">
                                                <input class="form-control" type="text" placeholder="ZIP / Code postal"
                                                    required>
                                                <div class="invalid-feedback">Please provide a valid zip!</div>
                                            </div>
                                            <button class="btn btn-outline-primary d-block w-100" type="submit">Calculer
                                                la livraison</button>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-credit-card-2-back fs-lg me-2" viewBox="0 0 16 16">
                                <path
