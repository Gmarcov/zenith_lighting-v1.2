                    ...
                    <form class="subscription-form validate"
                        ...
                        <div class="input-group flex-nowrap">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-envelope position-absolute top-50 translate-middle-y text-muted fs-base ms-3"
                                viewBox="0 0 16 16">
                                <path
        ...
        <div class="container">
            <div class="row pb-3">
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                            class="bi bi-truck text-primary" style="font-size: 2.25rem;"" viewBox=" 0 0 16 16">
                            <path
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                            class="bi bi-coin text-primary" viewBox="0 0 16 16">
                            <path
            ...
            <div class="row pb-2">
                <div class="col-md-6 text-center text-md-start mb-4">
                    <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-3" href="#"><img
                                class="d-block" src="../src/img/footer-logo-light.png" width="117" alt="Zenith"></a>
                    </div>
                ...
                <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© tous les droits sont
                    réservés 2021. Crée par <a class="text-light" href="https://marcsox.com" target="_blank"
                        rel="noopener">masterlys</a></div>
            </div>
        </div>
</footer>
<script>
