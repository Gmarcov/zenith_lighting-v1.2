        ...
        <div class="modal-content">
          <div class="modal-header bg-secondary">
            <ul class="nav nav-tabs card-header-tabs" role="tablist">
              <li class="nav-item"><a class="nav-link fw-medium active" href="#signin-tab" data-bs-toggle="tab" role="tab" aria-selected="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="me-2 mt-n1 bi bi-unlock" viewBox="0 0 16 16">
              ...
              <li class="nav-item"><a class="nav-link fw-medium" href="#signup-tab" data-bs-toggle="tab" role="tab" aria-selected="false">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="me-2 mt-n1 bi bi-person" viewBox="0 0 16 16">
          ...
          <div class="modal-body tab-content py-4">
            <form class="needs-validation tab-pane fade show active" autocomplete="off" novalidate id="signin-tab">
                ...
                <div class="password-toggle">
                  ...
                  <label class="password-toggle-btn" aria-label="Show/hide password">
                    <input class="password-toggle-check" type="checkbox">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye password-toggle-indicator" viewBox="0 0 16 16">
              ...
              <div class="mb-3 d-flex flex-wrap justify-content-between">
                <div class="form-check mb-2">
                  ...
                  <label class="form-check-label" for="si-remember">Se souvenir</label>
            ...
            <form class="needs-validation tab-pane fade" autocomplete="off" novalidate id="signup-tab">
              ...
              <button class="btn btn-primary btn-shadow d-block w-100" type="submit">S'enregistrer</button>
            </form>
          </div>
        </div>
      </div>
      ...
      <header class="shadow-sm">
        ...
        <div class="navbar-sticky bg-light">
          <div class="navbar navbar-expand-lg navbar-light">
            <div class="container"><a class="navbar-brand d-none d-sm-block me-3 flex-shrink-0" href="index.html"><img src="../src/img/logo-dark.png" width="142" alt="Zenith"></a><a class="navbar-brand d-sm-none me-2" href="index.html"><img src="img/logo-icon.png" width="74" alt="Zenith"></a>
              <!-- Search-->
              ...
              <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"><span class="navbar-toggler-icon"></span></button><a class="navbar-tool navbar-stuck-toggler" href="#"><span class="navbar-tool-tooltip">Menu</span>
                  ...
                  <div class="navbar-tool-text ms-n3"><small>Identifiez-vous</small>Mon Compte</div></a>
                <div class="navbar-tool dropdown ms-3">
                  <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="shop-cart.html"><span class="navbar-tool-label">4</span>
                  ...
                  <a class="navbar-tool-text" href="shop-cart.html"><small>Mon Panier</small>Dh1,247.00</a>
                  <!-- Cart dropdown-->
            ...
            <div class="container">
              <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Meilleur vente</a>
                    <div class="dropdown-menu p-0">
                      <div class="d-flex flex-wrap flex-sm-nowrap px-2">
