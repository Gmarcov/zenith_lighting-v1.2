                                ...
                                <div class="product-gallery">
                                    <div class="product-gallery-preview order-sm-2">
                                        <div class="product-gallery-preview-item active" id="first"><img
                                                class="image-zoom" src="img/shop/single/gallery/05.jpg"
                                    ...
                                    <div class="product-gallery-thumblist order-sm-1"><a
                                            class="product-gallery-thumblist-item active" href="#first"><img
                                                src="img/shop/single/gallery/th05.jpg" alt="Product thumb"></a><a
            ...
            <div class="navbar-sticky bg-light">
                <div class="navbar navbar-expand-lg navbar-light">
                    <div class="container"><a class="navbar-brand d-none d-sm-block me-3 flex-shrink-0"
                            href="index.html"><img src="../src/img/logo-dark.png" width="142" alt="Zenith"></a><a
                            class="navbar-brand d-sm-none me-2" href="index.html"><img src="img/logo-icon.png"
                                width="74" alt="Zenith"></a>
                        <!-- Search-->
                        ...
                        <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                                ...
                                ?>
                            </a><a class="navbar-tool ms-1 ms-lg-0 me-n1 me-lg-2" href="<?php echo $link; ?>"
                            ...
                            <div class="navbar-tool dropdown ms-3">
                                <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="shop-cart.html"><span
                                        class="navbar-tool-label">4</span>
                                ...
                                <a class="navbar-tool-text" href="shop-cart.html"><small>Mon
                                        Panier</small>Dh1,247.00</a>
                                <!-- Cart dropdown-->
                                    ...
                                    <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                            <div class="fs-sm me-2 py-2"><span class="text-muted">Total:</span><span
                                                    class="text-accent fs-base ms-1">Dh1,247.<small>00</small></span>
                                            </div><a class="btn btn-outline-secondary btn-sm" href="shop-cart.html">
                                                Details
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            ...
                            <ul class="navbar-nav navbar-mega-nav pe-lg-2 me-lg-2">
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle ps-lg-0" href="#"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-list align-middle mt-n1 me-1"
                                            viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="fs-sm mb-3">Starting from <span
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                ...
                                                                class="bi bi-chevron-right fs-xs ms-1"
                                                                viewBox="0 0 16 16">
                                                                <path fill-rule="evenodd"
                                                                    d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                                                            </svg>
                            ...
                            <ul class="navbar-nav">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown position-static mb-0"><a
                                            ...
                                            <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                                    href="home-electronics-store.html" style="width: 250px;"><img
                                                        src="img/home/preview/th03.jpg" alt="Electronics Store"></a>
                                            </div>
                                        </li>
                                        <li class="dropdown position-static mb-0"><a
                                                class="dropdown-item py-2 border-bottom"
                                        ...
                                        <li class="dropdown position-static mb-0"><a
                                                ...
                                                href="home-fashion-store-v2.html"><span
                                                    ...
                                                    class="d-block text-muted">Slider + Featured categories</small></a>
                                            <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                                    href="home-fashion-store-v2.html" style="width: 250px;"><img
                                                        src="img/home/preview/th02.jpg" alt="Fashion Store v.2"></a>
                                            </div>
                                        </li>
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                                        data-bs-toggle="dropdown">Meilleur vente</a>
                                    <div class="dropdown-menu p-0">
                                        <div class="d-flex flex-wrap flex-sm-nowrap px-2">
                                            <div class="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                                                <div class="widget widget-links mb-4">
                                                    ...
                                                    <ul class="widget-list">
                                                        ...
                                                        <li class="widget-list-item"><a class="widget-list-link"
                                                                href="shop-grid-ft.html">Shop Grid - Filters on Top</a>
                                                        </li>
                                                        <li class="widget-list-item"><a class="widget-list-link"
                                                        ...
                                                        <li class="widget-list-item"><a class="widget-list-link"
                                                                href="shop-list-ft.html">Shop List - Filters on Top</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="widget widget-links">
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="account-signin.html">Sign In / Sign Up</a>
                                        </li>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="docs/changelog.html">
                          <div class="d-flex">
                            ...
                            <div class="ms-2"><span class="d-block text-heading">Changelog<span class="badge bg-success ms-2">v2.1</span></span><small class="d-block text-muted">Regular updates</small></div>
                          </div></a></li>
                      <li class="dropdown-divider"></li>
                                ...
                                <div>
                                    <div class="row align-items-center">
                                        <div class="col-md-6 order-md-2"><img class="d-block mx-auto"
                                                src="../src/img/home/hero-slider/05.jpg" alt="VR Collection"></div>
                                        <div
                        ...
                        <div class="table-responsive" data-simplebar>
                            <div class="d-flex d-xl-block"><a
                                    ...
                                    href="#" style="min-width: 16rem;"><img
                                        src="../src/img/home/banners/banner-sm01.png" width="125" alt="Banner">
                                    <div class="py-4 px-2">
                                    ...
                                    href="#" style="min-width: 16rem;"><img
                                        src="../src/img/home/banners/banner-sm02.png" width="125" alt="Banner">
                                    <div class="py-4 px-2">
                                    ...
                                    href="#" style="min-width: 16rem;"><img
                                        src="../src/img/home/banners/banner-sm03.png" width="125" alt="Banner">
                                    <div class="py-4 px-2">
                    ...
                    <div class="card product-card">
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/58.jpg" alt="Product"></a>
                    ...
                    <div class="card product-card"><span class="badge bg-danger badge-shadow">Sale</span>
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/59.jpg" alt="Product"></a>
                    ...
                    <div class="card product-card">
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/60.jpg" alt="Product"></a>
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">TV, Video &amp;
                                Audio</a>
                            <h3 class="product-title fs-sm"><a href="shop-single-v2.html">Smart TV LED 49’’ Ultra HD</a>
                            </h3>
                            <div class="d-flex justify-content-between">
                    ...
                    <div class="card product-card">
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/61.jpg" alt="Product"></a>
                    ...
                    <div class="card product-card">
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/62.jpg" alt="Product"></a>
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">Wearable
                                Electronics</a>
                            <h3 class="product-title fs-sm"><a href="shop-single-v2.html">Fitness GPS Smart Watch</a>
                            </h3>
                            <div class="d-flex justify-content-between">
                    ...
                    <div class="card product-card">
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/63.jpg" alt="Product"></a>
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">Smartphones</a>
                            <h3 class="product-title fs-sm"><a href="shop-single-v2.html">Popular Smartphone 128GB</a>
                            </h3>
                            <div class="d-flex justify-content-between">
                    ...
                    <div class="card product-card"><span class="badge bg-info badge-shadow">New</span>
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/64.jpg" alt="Product"></a>
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">Wearable
                                Electronics</a>
                    ...
                    <div class="card product-card">
                        <div class="product-card-actions d-flex align-items-center"><a
                            ...
                            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip"
                                ...
                                src="../src/img/shop/catalog/65.jpg" alt="Product"></a>
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">Computers</a>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 mb-2 py-3">
                    <div class="widget">
                        ...
                        <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/cart/widget/05.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                        ...
                        <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/cart/widget/06.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                        ...
                        <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/cart/widget/07.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                        ...
                        <div class="d-flex align-items-center py-2"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/cart/widget/08.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                                <h6 class="widget-product-title"><a href="shop-single-v2.html">Android Smart TV Box</a>
                                </h6>
                ...
                <div class="col-md-4 col-sm-6 mb-2 py-3">
                    <div class="widget">
                        ...
                        <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/06.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                                <h6 class="widget-product-title"><a href="shop-single-v2.html">Monoblock Desktop PC</a>
                                </h6>
                                <div class="widget-product-meta"><span
                        ...
                        <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/07.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                        ...
                        <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/08.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                        ...
                        <div class="d-flex align-items-center py-2"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/09.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                ...
                <div class="col-md-4 col-sm-6 mb-2 py-3">
                    <div class="widget">
                        ...
                        <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/10.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                        ...
                        <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/11.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                                <h6 class="widget-product-title"><a href="shop-single-v2.html">Wireless Bluetooth
                                        Headphones</a></h6>
                        ...
                        <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/12.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                                <h6 class="widget-product-title"><a href="shop-single-v2.html">360 Degrees Camera</a>
                                </h6>
                        ...
                        <div class="d-flex align-items-center py-2"><a class="d-block flex-shrink-0"
                                href="shop-single-v2.html"><img src="../src/img/shop/widget/13.jpg" width="64"
                                    alt="Product"></a>
                            <div class="ps-2">
                                <h6 class="widget-product-title"><a href="shop-single-v2.html">Digital Camera 40MP</a>
                                </h6>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="bg-secondary p-5 text-center"><img class="d-block mb-4 mx-auto"
                                src="img/home/yt-logo.png" width="120" alt="YouTube">
                            <div class="d-flex justify-content-center align-items-center mb-4"><img class="me-2"
                                    src="img/home/yt-subscribers.png" width="126" alt="YouTube Subscribers"><span
                                    class="fs-sm">250k+</span></div><a class="btn btn-primary border-0 btn-sm mb-3"
                                href="#" style="background-color: #ff0000;"><i
                        ...
                        <div class="row g-0">
                            <div class="col-lg-4 col-6 mb-3"><a class="d-block text-decoration-0 px-2"
                                    ...
                                    <div class="position-relative mb-2"><span
                                            ...
                                            class="w-100" src="img/home/video/cover01.jpg" alt="Video cover"></div>
                            ...
                            <div class="col-lg-4 col-6 mb-3"><a class="d-block text-decoration-0 px-2"
                                    ...
                                    <div class="position-relative mb-2"><span
                                            ...
                                            class="w-100" src="img/home/video/cover02.jpg" alt="Video cover"></div>
                            ...
                            <div class="col-lg-4 col-6 mb-3"><a class="d-block text-decoration-0 px-2"
                                    ...
                                    <div class="position-relative mb-2"><span
                                            ...
                                            class="w-100" src="img/home/video/cover03.jpg" alt="Video cover"></div>
                            ...
                            <div class="col-lg-4 col-6 mb-3 d-lg-none"><a class="d-block text-decoration-0 px-2"
                                    ...
                                    <div class="position-relative mb-2"><span
                                            ...
                                            class="w-100" src="img/home/video/cover04.jpg" alt="Video cover"></div>
