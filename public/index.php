                    ...
                    <div class="row height d-flex justify-content-center align-items-center">
                        <div class="col-md-6">
                            <div class="form search-navbar">
                                <a href="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#374151"
                                ...
                                <input type="text" class="form-control form-input"
                                    placeholder="Trouvez votre produits..">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer>
        <div class="container">
            ...
            <div class="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" class="bi bi-three-dots"
                    viewBox="0 0 16 16">
                    <path
            ...
            <div class="row text-center">
                <div class="col-md-4 box">
                    <span class="copyright quick-links">Copyright &copy; Zenith Lighting <script>
